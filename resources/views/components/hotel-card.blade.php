    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section class="mb-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <x-room-card :roomType="$roomType" :showAvailableCount="true" />
                @endforeach
            </div>
            @else
            <div
            ...
            <div class="mb-8 relative group">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-md border-2 border-blue-200">
                    ...
                    <form action="{{ route('review.store', $hotel->id) }}" method="POST" class="space-y-4">
                        ...
                        <!-- Submit Button -->
                        <button type="submit"
                            class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all hover:scale-105">
                ...
                <div class="relative">
                    <div
                        ...
                        <div class="space-y-4">
                            ...
                            <button type="button"
                                class="inline-flex items-center gap-2 px-6 py-3 bg-gray-400 text-white rounded-xl font-semibold">
                                Submit Review
                            </button>
                        </div>
                    </div>
