...
<body>
    ...
    <!-- Navbar -->
    <nav
        style="background-color:#1a2a5b; color:white; padding:15px 20px; display:flex; justify-content:space-between; align-items:center;">
        {{-- Hotel Name --}}
        ...
        <div style="display:flex; align-items:center; gap:15px;">
            ...
            @guest
            <a href="/login"
                style="color:white; text-decoration:none; padding:8px 12px; border:1px solid white; border-radius:4px;">Login</a>
            <a href="/register"
                style="color:#1a2a5b; background:white; text-decoration:none; padding:8px 12px; border-radius:4px;">Register</a>
            @endguest
            {{-- Hamburger Icon --}}
...
">
    ...
    ">&times;</a>
        ...
        <ul style="list-style:none; padding:0; margin:0; color:white;">
            ...
            <li><a href="/profile"
                    style="display:block; padding:12px 20px; color:white; text-decoration:none;">Profile</a></li>
            <li><a href="/reservations"
                    style="display:block; padding:12px 20px; color:white; text-decoration:none;">Reservations &
                    Rewards</a></li>
            @auth
            <li>
    ...
    <footer style="background-color:#0a1f44; color:white; padding:50px 20px; text-align:left;">
        <div
            ...
            <div style="flex: 1; min-width: 220px;">
                ...
                <p style="font-size: 15px; line-height:1.8;">
                    HotelGo helps guests book rooms easily and securely while assisting hotels in managing reservations
                    efficiently. Experience comfort, convenience, and exceptional service with us.
                </p>
            </div>
            ...
            <div style="flex: 1; min-width: 200px;">
                ...
                <p style="font-size: 15px; line-height:1.8;">
                    📍 Lebanon, Beirut<br>
                    📞 +961 70 123 456<br>
                    ✉️ <a href="mailto:info@hotelgo.com"
                        style="color:white; text-decoration:underline;">info@hotelgo.com</a>
                </p>
            </div>
        ...
        {{-- Bottom Copyright --}}
        <div
            style="margin-top: 50px; border-top: 1px solid #07152f; padding-top: 20px; font-size: 14px; text-align:center;">
