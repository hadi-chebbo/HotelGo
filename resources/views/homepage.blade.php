...
<section style="padding:50px 20px; text-align:center; background-color:#fafafa;">
    ...
    <div
        style="display:flex; flex-wrap:wrap; justify-content:center; gap:50px; max-width:1000px; margin:auto; align-items:flex-start;">
        ...
        <div style="flex:1 1 220px; display:flex; flex-direction:column; align-items:center;">
            ...
            <p style="font-size:16px; color:#555; margin:0;">Easily find hotels or rooms based on your location and
                preferences.</p>
        </div>
        ...
        <div style="flex:1 1 220px; display:flex; flex-direction:column; align-items:center;">
            ...
            <p style="font-size:16px; color:#555; margin:0;">Browse through a variety of room types and choose the one
                that suits you.</p>
        </div>
        ...
        <div style="flex:1 1 220px; display:flex; flex-direction:column; align-items:center;">
            ...
            <p style="font-size:16px; color:#555; margin:0;">Compare prices and book your perfect stay with confidence.
            </p>
        </div>
        ...
        <div class="rooms-track">
            @foreach($roomTypes as $room)
                <div style="flex: 0 0 auto; width: 320px;">
                    <x-room-card :roomType="$room" :compact="true" />
                </div>
            @endforeach
            @foreach($roomTypes as $room)
                <div style="flex: 0 0 auto; width: 320px;">
